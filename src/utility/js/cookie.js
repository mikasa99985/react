export var cookie = new Object();

cookie.append = function (cookieName, item, expDays) {
    item = cm_clean(item);
...
cookie.splice = function (cookieName, index, numberToRemove, expDays) {
    var cookievalue = cookie.get(cookieName);
    if (cookievalue instanceof Array) {
...
cookie.set = function (cookieName, value, expDays) {
