    ...
    <>
      ...
      <div className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered modal-cos">
          <div className="modal-content mb-4" style={{ height: "65vh", width: "58vh", background: "white" , right:"2vh", top:"2vh" }}>
            <div className="modal-header" style={{ height: "7vh" , backgroundImage:`url(${Chatbanner})`  }} >
              <img src={Slack} width={28} alt="" />
            ...
            <button type="button" className={`btn btn-primary rgbbutton1 ${zoomClass}`} onMouseEnter={() => setIsZoomed(true)} onMouseLeave={() => setIsZoomed(false)} style={{ width: "7vh", height: "7vh", left: "8px", top:"7px" , display: "flex", alignItems: "center", position:"relative" , justifyContent: "center", borderRadius: "50px", background: "black" }} >  send  </button>
            </div>
          </div>
        </div>
      </div>
