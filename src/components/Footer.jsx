  ...
  return (
    <>
      ...
      <div class="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-cos">
          <div class="modal-content mb-4" style={{height:"65vh" , width:"70vh" ,  background: "linear-gradient(to left, yellow 50%, #ff0099 50%)", borderRadius:"14% 86% 57% 43% / 51% 55% 45% 49% "}}>
